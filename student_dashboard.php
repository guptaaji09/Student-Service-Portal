...
<div class="container-fluid">
            ...
            <h4 style="text-align:center;color:#fff; font-family: 'Ubuntu', sans-serif;margin-bottom:30px;" class="typewrite" data-period="2000"
                data-type='[ "Hi, what can I do for you?", "Require LOR?", "Certificate?"," or Resume?"]'>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <div class="card border-0 shadow">
                        <a href="gen_lor4.php"><img src="imgs/social-media.png" class="card-img-top" alt="..."></a>
                        <div class="card-body text-center">
                            <h5 class="card-title mb-0"><b>Letter of Recommendation</b></h5>
                            <div class="card-text text-black-50">Download LORs instantly and get it approved by the respective faculty.</div>
                        </div>
                    </div>
                </div>
                <!-- Team Member 2 -->
                <div class="col-xl-4 col-md-6 mb-4">
                    <div class="card border-0 shadow ">
                        <a href="certificatess.php"><img src="imgs/certificate.png" class="card-img-top" alt="..."></a>
                        <div class="card-body text-center">
                            <h5 class="card-title mb-0"><b>Certificate Generator</b></h5>
                            <div class="card-text text-black-50">Bonafide, Leaving, Transfer...get all your certificate needs solved at one place.</div>
                        </div>
                    </div>
                </div>
                <!-- Team Member 3 -->
                <div class="col-xl-4 col-md-6 mb-4">
                    <div class="card border-0 shadow">
                        <a href="res_cer2.php"><img src="imgs/cv.png" class="card-img-top" alt="..."></a>
                        <div class="card-body text-center">
                            <h5 class="card-title mb-0"><b>Resume Maker</b></h5>
                            <div class="card-text text-black-50">Get your CV generated fast and easily with this awesome tool.</div>
                        </div>
                    </div>
                </div>
